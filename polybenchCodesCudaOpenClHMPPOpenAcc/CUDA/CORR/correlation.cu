...
void init_arrays(DATA_TYPE* data, int m, int n)
{
	int i, j;
...
__global__ void mean_kernel(DATA_TYPE *mean, DATA_TYPE *data, int m, int n)
{
...
__global__ void std_kernel(DATA_TYPE *mean, DATA_TYPE *std, DATA_TYPE *data, int m, int n)
{
	int j = blockIdx.x * blockDim.x + threadIdx.x + 1;
...
__global__ void reduce_kernel(DATA_TYPE *mean, DATA_TYPE *std, DATA_TYPE *data, int m, int n)
{
	int j = blockIdx.x * blockDim.x + threadIdx.x + 1;
...
__global__ void corr_kernel(DATA_TYPE *symmat, DATA_TYPE *data, int m, int n)
{
...
void correlationCuda(DATA_TYPE* data, DATA_TYPE* mean, DATA_TYPE* stddev, DATA_TYPE* symmat,
			DATA_TYPE* symmat_outputFromGpu, int m, int n)
{
...
int main(int argc, char** argv)
{
	...
	correlationCuda(data, mean, stddev, symmat, symmat_outputFromGpu, m, n);

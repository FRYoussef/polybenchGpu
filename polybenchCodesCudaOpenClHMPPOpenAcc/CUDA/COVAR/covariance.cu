...
__global__ void reduce_kernel(DATA_TYPE *mean, DATA_TYPE *data, int m, int n)
{
	int j = blockIdx.x * blockDim.x + threadIdx.x + 1;
...
__global__ void covar_kernel(DATA_TYPE *symmat, DATA_TYPE *data, int m, int n)
{
...
void covarianceCuda(DATA_TYPE* data, DATA_TYPE* symmat, DATA_TYPE* mean, DATA_TYPE* symmat_outputFromGpu, int m, int n)
{
...
int main(int argc, char** argv)
{
	...
	covarianceCuda(data, symmat, mean, symmat_outputFromGpu, m, n);
